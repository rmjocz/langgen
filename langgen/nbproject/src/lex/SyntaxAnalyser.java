...
//          return cset.size()>0 ? cset.toArray(new AbstractAscSet[0]) : null;
        ...
        // trzeba by zmienic dzialanie tego automatu _abstractAscSet() 
        // musial by byc bufor aby wczytac do konstruktora AscLstVal ktory pobiera caly string
        // czyli mozna by po znaku char dopisywac do obiektu klasy String
        // tutaj w tym momencie obsluguje pojedyncza wartosc albo zakres
        // pierwszy element z zakresu jest pobierany z bufora tmp jako wartosc poprzednio wczytana
